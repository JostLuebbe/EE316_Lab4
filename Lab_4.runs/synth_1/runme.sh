...
HD_PWD='C:/Vivado Projects/Lab_4/Lab_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log call_system_dataflow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source call_system_dataflow.tcl
